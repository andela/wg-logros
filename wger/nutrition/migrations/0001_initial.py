# -*- coding: utf-8 -*-
# Generated by Django 1.9.13 on 2018-02-27 11:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('license_author', models.ForeignKey(blank=True, help_text='If you are not the author, select the author name from the list. This is needed for some  licenses e.g. the CC-BY-SA.', max_length=50, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.Author', to_field='name', verbose_name='Author')),
